...
const FeatureCard = ({ icon: Icon, title, description, className, index }) => {
    ...
    return (
        ...
        >
            <div className="w-10 h-10 bg-slate-50 flex items-center justify-center mb-6 transition-transform duration-300 group-hover:-translate-y-1">
                <Icon className="w-5 h-5 text-slate-950" aria-hidden="true" />
            </div>
            {/* Benefit-first Title */}
            <h3 className="text-xl font-bold text-slate-50 mb-3 tracking-tight">{title}</h3>
            {/* Context/Proof Description */}
            <p className="text-slate-400 leading-relaxed text-balance">{description}</p>
        </motion.div>
    );
};
...
const FeatureBento = () => {
    return (
        <section id="features" className="py-32 relative border-t border-slate-900">
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-px bg-slate-800 border border-slate-800 max-w-6xl mx-auto overflow-hidden">
                    {/* Large Card 1 */}
                    <FeatureCard
                        icon={Bot}
                        ...
                        className="md:col-span-2 md:row-span-2 bg-[#020617]"
                        index={0}
                    />
                    ...
                    <FeatureCard
                        ...
                        className="md:col-span-2 bg-[#020617]"
                        index={3}
                    />
