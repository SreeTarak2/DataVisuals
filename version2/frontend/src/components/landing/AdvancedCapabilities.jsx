...
const AdvancedCapabilities = () => {
    return (
        <section id="capabilities" className="py-32 relative bg-slate-950/50 overflow-hidden">
            {/* Background elements */}
            <div className="absolute right-0 top-0 w-1/2 h-1/2 bg-sky-900/10 blur-[150px] -z-10 rounded-full" />
            <div className="absolute left-0 bottom-0 w-1/2 h-1/2 bg-purple-900/10 blur-[150px] -z-10 rounded-full" />
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center mb-32">
                    ...
                    >
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold mb-4 text-slate-50 tracking-tight">Automated AI Insights</h3>
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true, margin: "-100px" }}
                        transition={{ duration: 0.6 }}
                        className="order-1 md:order-2 aspect-square md:aspect-[4/3] rounded-2xl border border-white/10 bg-slate-900 flex items-center justify-center relative shadow-2xl overflow-hidden"
                    >
                        ...
                        <div className="space-y-4 w-3/4">
                            ...
                            <div className="h-24 w-full bg-sky-500/20 border border-sky-500/30 rounded-lg mt-6" />
                        </div>
                    </motion.div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
                    <motion.div
                        ...
                        viewport={{ once: true, margin: "-100px" }}
                        transition={{ duration: 0.6 }}
                        className="aspect-square md:aspect-[4/3] rounded-2xl border border-white/10 bg-slate-900 flex items-center justify-center relative shadow-2xl overflow-hidden"
                    >
                        <div className="absolute inset-0 bg-gradient-to-tr from-purple-500/10 to-transparent"></div>
                        <div className="w-3/4 h-3/4 flex gap-4 items-end justify-center">
                            {[40, 70, 45, 90, 60, 100].map((h, i) => (
                                <div key={i} className="w-8 bg-purple-500/60 rounded-t-md relative flex-shrink-0" style={{ height: `${h}%` }}>
                                    {i === 3 && (
                                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-white text-slate-950 text-xs font-bold py-1 px-2 rounded">
                                            Target
                                        </div>
                                    )}
                                </div>
                    ...
                    >
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold mb-4 text-slate-50 tracking-tight">Smart Chart Selection</h3>
                        <p className="text-slate-400 text-lg leading-relaxed mb-6">
                        ...
                        <button className="text-slate-50 hover:text-white font-medium border-b border-purple-400 pb-0.5 transition-colors">
