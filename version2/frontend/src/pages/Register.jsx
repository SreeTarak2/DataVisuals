          ...
          <div className="max-w-[400px] w-full mx-auto space-y-8">
            ...
            <form className="space-y-6" onSubmit={handleRegister}>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox id="terms" className="w-4 h-4 border-zinc-700 data-[state=checked]:bg-indigo-600 data-[state=checked]:border-indigo-600" />
                <label htmlFor="terms" className="text-sm text-zinc-400 cursor-pointer select-none">
                  Agree to <Link to="#" className="text-indigo-400 hover:underline">Terms</Link> and <Link to="#" className="text-indigo-400 hover:underline">Privacy</Link>
                </label>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#09090b] px-2 text-zinc-500">Or register with</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                <Button 
                  ...
                  className="w-full border-zinc-800 bg-zinc-900/50 hover:bg-zinc-800 text-zinc-300 h-11 text-base transition-all cursor-pointer"
                >
