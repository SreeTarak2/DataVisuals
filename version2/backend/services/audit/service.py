...
class AuditService:
    ...
    async def log_event(
        ...
        result = await self.db.audit_events.insert_one(entry)
    ...
    async def delete_user_data(
        ...
        try:
            ...
            logger.info(
                f"GDPR: Deleted {result.deleted_count} audit records for user {user_id[:8]}..."
            )
            ...
            if results:
                ...
                return {
                    ...
                    "error_rate": round(
                        ...
                        / max(result.get("total_requests", 1), 1)
                        * 100,
                        2,
                    ),
