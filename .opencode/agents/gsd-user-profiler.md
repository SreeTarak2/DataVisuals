...
<reference>
@/home/vamsi/nothing/datasage/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/vamsi/nothing/datasage/.opencode/get-shit-done/references/user-profiling.md` to load:
