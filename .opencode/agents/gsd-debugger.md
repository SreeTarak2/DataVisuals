...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/vamsi/nothing/datasage/.opencode
                  → checks /home/vamsi/nothing/datasage/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/vamsi/nothing/datasage/.opencode/get-shit-done
                  → writes to /home/vamsi/nothing/datasage/.opencode/get-shit-done/hooks/
...
@/home/vamsi/nothing/datasage/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/vamsi/nothing/datasage/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/vamsi/nothing/datasage/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/vamsi/nothing/datasage/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/vamsi/nothing/datasage/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
