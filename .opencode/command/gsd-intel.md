...
Intel system is disabled. To activate:
  ...
  node /home/vamsi/nothing/datasage/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/vamsi/nothing/datasage/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/vamsi/nothing/datasage/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/vamsi/nothing/datasage/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /home/vamsi/nothing/datasage/.opencode/get-shit-done/bin/gsd-tools.cjs
