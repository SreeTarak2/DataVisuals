...
- **Global scope**: `/home/vamsi/nothing/datasage/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/vamsi/nothing/datasage/.opencode/notes/`)
...
2. Glob `/home/vamsi/nothing/datasage/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/vamsi/nothing/datasage/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/vamsi/nothing/datasage/.opencode/notes/` — works in any directory
